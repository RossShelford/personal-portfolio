    ...
    {mobileActive ? (null) : (
      <div className="h-screen w-screen bg-cream dark:bg-flint fixed justify-center items-center z-50">
        <div className="flex flex-col items-center">
          <Link to="/" onClick={toggleMobile} className="text-6xl m-3 font-poppins font-bold cursor-pointer dark:text-cream hover:text-lavender dark:hover:text-lavender">
            <span>HOME</span>
          </Link>
          ...
          <Link to="/about" onClick={toggleMobile} className="text-6xl m-3 font-poppins font-bold cursor-pointer dark:text-cream hover:text-mint dark:hover:text-mint">
            <span>ABOUT</span>
          </Link>
          <Link to="/contact" onClick={toggleMobile} className="text-6xl m-3 font-poppins font-bold cursor-pointer dark:text-cream hover:text-sunflower dark:hover:text-sunflower">
            <span >CONTACT</span>
          </Link>
