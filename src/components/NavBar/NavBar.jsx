...
function NavBar() {
  ...
  return (
    <nav>
      <div className={`hidden bg-cream w-full h-20 items-center flex drop-shadow-sm select-none transition-all dark:drop-shadow-md dark:transition-all dark:bg-flint`}>
    ...
    <button onClick={toggleMobile} className='flex sm:hidden cursor-pointer'>
     <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mx-10 stroke-flint dark:stroke-cream" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {/* Mobile Menu */}
      <div className="h-screen w-screen bg-cream dark:bg-flint fixed justify-center z-50">
        <div className="flex flex-col items-center">
          ...
          <button className="justify-end m-10 mx-14"><ThemeIcon /></button>
        </div>
