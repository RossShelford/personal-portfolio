...
function NavBar() {
  ...
  <nav className="fixed z-50 bg-cream w-full h-20 items-center flex drop-shadow-sm select-none transition-all dark:transition-all dark:bg-flint">
      <svg id="nameLogo" className="fill-current h-10 justify-start mr-auto ml-6 cursor-pointer animate-spin-slow dark:text-cream" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 250" >
      ...
      <div className="justify-end">
        <span className="ml-6 hover:underline hover:decoration-lavender hover:decoration-wavy cursor-pointer dark:text-cream">WORK</span>
        <span className="ml-6 hover:underline hover:decoration-salmon hover:decoration-wavy cursor-pointer dark:text-cream">ABOUT</span>
        <span className="ml-6 hover:underline hover:decoration-mint hover:decoration-wavy cursor-pointer dark:text-cream">CONTACT</span>
      </div>
