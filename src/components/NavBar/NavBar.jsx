...
const ThemeIcon = () => {
  ...
  return (
    <span onClick={handleMode}>
      {darkTheme ? (
        <img src={dayModeIcon} alt="Day Mode Theme" className="h-6 mx-14 cursor-pointer transition-all dark:transition-all"/>
      ) : (
        <img src={nightModeIcon} alt="Night Mode Theme" className="h-6 mx-14 cursor-pointer transition-all dark:transition-all"/>
      )}
    </span>
  );
};
...
function NavBar() {
  return (
  <nav className="fixed bg-cream w-full h-20 items-center flex drop-shadow-sm select-none transition-all dark:transition-all dark:bg-flint">
      ...
      <div className="justify-end">
        <span className="ml-6 hover:underline cursor-pointer dark:text-cream">WORK</span>
        <span className="ml-6 hover:underline cursor-pointer dark:text-cream">ABOUT</span>
        <span className="ml-6 hover:underline cursor-pointer dark:text-cream">CONTACT</span>
      </div>
      <ThemeIcon />
  </nav>
  );
