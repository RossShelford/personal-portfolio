...
<div className='flex flex-col'>
    ...
    <div className='selection:bg-mint w-4/6'>
      <h3 className='font-poppins text-3xl px-10 pb-3 pt-10 dark:text-cream'>Brand identity to reflect the evolution and rapid growth of the business</h3>
      <p className='font-poppins text-sm px-10 leading-relaxed dark:text-cream'>In order to move away from a simple rounded look, a new stylish font was introduced to harden up the text and reflect the challenges of the day.  The colour palette was extended to include teal, yellow, and magenta options, further asserting the competitive edge of what has become widely known as ‘the Imagineear purple’, as always accompanied by a bolder green – a far cry from the muted green over a decade earlier.
